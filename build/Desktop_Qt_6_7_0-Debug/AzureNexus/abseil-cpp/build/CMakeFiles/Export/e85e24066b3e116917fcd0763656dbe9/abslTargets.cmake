...
add_library(absl::exception_safety_testing STATIC IMPORTED)
...
add_library(absl::atomic_hook_test_helper STATIC IMPORTED)
...
add_library(absl::spinlock_test_common STATIC IMPORTED)
...
add_library(absl::test_instance_tracker STATIC IMPORTED)
...
add_library(absl::hash_generator_testing STATIC IMPORTED)

set_target_properties(absl::hash_generator_testing PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::hash_policy_testing;absl::memory;absl::meta;absl::no_destructor;absl::strings"
)
...
add_library(absl::stack_consumption STATIC IMPORTED)
...
add_library(absl::log_internal_test_actions STATIC IMPORTED)
...
add_library(absl::log_internal_test_helpers STATIC IMPORTED)
...
add_library(absl::log_internal_test_matchers STATIC IMPORTED)
...
set_target_properties(absl::random_internal_mock_overload_set PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::random_mocking_bit_gen;absl::random_internal_mock_helpers"
)
...
set_target_properties(absl::random_mocking_bit_gen PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::core_headers;absl::flat_hash_map;absl::raw_logging_internal;absl::random_internal_mock_helpers;absl::random_internal_mock_overload_set;absl::random_internal_mock_validators;absl::random_random;absl::utility;GTest::gmock;GTest::gtest"
)
...
# Create imported target absl::random_internal_mock_validators
add_library(absl::random_internal_mock_validators INTERFACE IMPORTED)

set_target_properties(absl::random_internal_mock_validators PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::random_internal_iostream_state_saver;absl::random_internal_uniform_helper;absl::config;absl::raw_logging_internal;absl::strings;absl::string_view"
)
...
add_library(absl::status_matchers STATIC IMPORTED)
...
add_library(absl::pow10_helper STATIC IMPORTED)
...
set_target_properties(absl::cordz_test_helpers PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::cord;absl::cord_internal;absl::cordz_info;absl::cordz_sample_token;absl::cordz_statistics;absl::cordz_update_tracker;absl::core_headers;absl::nullability;absl::strings"
)
...
add_library(absl::per_thread_sem_test_common STATIC IMPORTED)
...
add_library(absl::time_internal_test_util STATIC IMPORTED)
...
foreach(_target "GTest::gtest" "GTest::gmock" )
